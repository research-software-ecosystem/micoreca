...
REASON_MAPPING = {
    ...
    # Modification ici: format court demandé pour les descriptions
    "biotools_description": "{value} in biotools description",
    ...
    def _write_report(self, report_file: Path, total_deleted: int, total_kept: int):
        ...
        try:
            with open(report_file, 'w', encoding='utf-8') as f:
                ...
                f.write(f" 3. Validated by Filter 3 (Description Match) : {self.report_counts['validated_filter_3']}\n\n")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n--- LOADED CRITERIA ---")
        print(f"EDAM Topics: {len(TARGET_TOPICS)} terms")
